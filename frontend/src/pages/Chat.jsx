...
function Chat({ user, onLogout }) {
  ...
  // Connect to Socket.io and fetch conversations on mount
  useEffect(() => {
    fetchConversations();
    ...
    if (user?._id) {
      ...
      socketService.on('new_message', ({ message, conversationId }) => {
        ...
        setSelectedConversation(current => {
          if (current?._id === conversationId) {
            console.log('✅ Current conversation matches, updating messages');
            setMessages(prev => {
              // Get the senderId as string for comparison
              ...
              // Check if message already exists (avoid duplicates from multiple socket events)
            ...
            console.log('⏭️ Different conversation, not updating messages');
          }
          return current;
        });
  ...
  const handleSendMessage = async (e) => {
    ...
    try {
      ...
      // Socket will handle updating with real message
      // Remove optimistic message after a delay if socket didn't update
      setTimeout(() => {
        setMessages(prev => {
          const stillHasTemp = prev.some(m => m._id === tempId);
          if (stillHasTemp) {
            // Socket didn't deliver, remove temp message
        ...
        <div className="sidebar-header">
          ...
          <div className="header-actions">
            <div className="header-btn" onClick={handleLogoutClick} title="Logout">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#a50000ff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="feather feather-power"><path d="M18.36 6.64a9 9 0 1 1-12.73 0"></path><line x1="12" y1="2" x2="12" y2="12"></line></svg>
            </div>
          </div>
        </div>
        ...
        <div className="contact-info">
          ...
          <div className='contact-content'>
            <div className="contact-section">
              <h3>About</h3>
              <p>Hello My name is {getConversationName(selectedConversation)} ...</p>
            </div>
          ...
          <div className="danger-zone">
            <div className="danger-btn">
              ...
              Block {getConversationName(selectedConversation)}</div>
            <div className="danger-btn">
              <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              Report {getConversationName(selectedConversation)}
            </div>
            <div className="danger-btn">
              <svg width="22" height="22" viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
